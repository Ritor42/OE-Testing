...
namespace SpecflowSudent.Widgets
{
    public class SearchWidget : BasePage
    {
        ...
        public void FillForm(SearchModel searchModel)
        {
            SetRoute(searchModel.FromCity, searchModel.ToCity, searchModel.ViaCity);
            SetReduction(searchModel.Reduction);
            SetSearchOptionTo(searchModel.SearchOption);
        }
